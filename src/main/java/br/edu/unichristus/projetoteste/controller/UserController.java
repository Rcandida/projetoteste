...
import br.edu.unichristus.projetoteste.service.UserService;
...
public class UserController {
	...
	@Operation(summary = "Altera os dados de um usuário a partir do ID | role: [ADMIN]", tags = "User")
	@PutMapping
	...
	@Operation(summary = "Retorna os dados de todos os usuários cadastrados | role: [ADMIN]", tags = "User")
	@GetMapping	
