...
import br.edu.unichristus.projetoteste.exception.GlobalExceptionHandler;

@ControllerAdvice //controla, gerencia para interceptar exceção e verificar onde a exceção se encaixa
